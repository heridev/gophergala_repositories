...
// source: delete/delete.proto
// DO NOT EDIT!

/*
Package gevvent_service_event_delete is a generated protocol buffer package.
...
It has these top-level messages:
	...
	Response
*/
package gevvent_service_event_delete
...
func (m *Request) MarshalTo(data []byte) (n int, err error) {
	...
	data[i] = 0xa
	i++
	i = encodeVarintDelete(data, i, uint64(len(m.EventID)))
	i += copy(data[i:], m.EventID)
	data[i] = 0x12
	i++
	i = encodeVarintDelete(data, i, uint64(len(m.UserID)))
...
func encodeFixed64Delete(data []byte, offset int, v uint64) int {
	data[offset] = uint8(v)
...
func encodeFixed32Delete(data []byte, offset int, v uint32) int {
	data[offset] = uint8(v)
	data[offset+1] = uint8(v >> 8)
	data[offset+2] = uint8(v >> 16)
	data[offset+3] = uint8(v >> 24)
